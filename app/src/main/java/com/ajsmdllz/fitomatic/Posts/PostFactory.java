...
public class PostFactory {
    public Post createPost(String author, String title, String description, String date, ArrayList<String> activities, String location, String image, ArrayList<String> followers, int max, int likes) {
